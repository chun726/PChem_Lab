...
x1, y1 = np.loadtxt(r'D:\matplot\2023_03_24_PChem4\chloroform_ir.txt', 
...
plt.ylabel(r"$\epsilon$ ($M^{-1}$ $cm^{-1}$)", labelpad = 10, fontname = 'Arial', fontsize = 12, color = 'black', loc='center')
